...
class LyingFormatterIsCaught(unittest.TestCase):
    DETERMINISTIC = ["binary_search", "bfs", "dfs_iter", "kruskal", "merge_sort", "quick_sort", "insertion_sort", "selection_sort", "bubble_sort", "heap_sort", "dijkstra",
                     ...
                     "house_robber", "max_subarray", "rod_cutting", "edit_distance",   # T5 DP wave
                         ...
                         "app.services.examples.trace_adapters.families.table_engine",
                         fromlist=["registered_specs"]).registered_specs()   # every live TableSpec (T14)
                     ] + [s.slug for s in __import__(
                         ...
                         "app.services.examples.trace_adapters.families.derivation_engine",
                         fromlist=["registered_specs"]).registered_specs()   # every live DerivationSpec (CP12d)
                     ] + [s.slug for s in __import__(
                         "app.services.examples.trace_adapters.families.stateful_engine",
                         fromlist=["registered_specs"]).registered_specs()]   # every live StatefulSpec (CP12e)
