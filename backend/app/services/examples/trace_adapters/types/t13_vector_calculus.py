...
from . import declare
from ..families.vector_calculus import LineIntegralAdapter, StokesTheoremAdapter, SurfaceIntegralAdapter
...
DECLARATIONS = [STOKES_THEOREM, LINE_INTEGRAL, SURFACE_INTEGRAL]
