...
_FIRST_PASS_SYSTEM = (
    ...
    "shorten, or re-order them) as the example input. Otherwise, for any array/list-based example, choose "
    "an input with AT LEAST `min_example_array_size` elements — never a tiny 3-4 element array, which "
    "hides the algorithm's behaviour.\n"
