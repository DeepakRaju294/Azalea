...
- A CLEAN, NATURAL IMPLEMENTATION WITH A NAMED ENTRY POINT (plain top-level functions by default). Implement the algorithm exactly the way a competent engineer would when simply asked "implement <algorithm>" — the same clean solution, no scaffolding. Requirements:
