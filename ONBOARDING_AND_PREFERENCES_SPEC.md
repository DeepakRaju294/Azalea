...
| `TRACE_TO_TEACHING_CONTRACT_SPEC.md` *(to write)* | trace↔prose consistency (Q23) | companion |
| `FREE_TEXT_CONTENT_VALIDATION_SPEC.md` *(to write)* | factual checking of free-text cards (Q24) | companion |
